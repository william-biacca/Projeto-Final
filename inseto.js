...
(async function init() {
  ...
  await fetchAndCreateCard("Kakuna");
  await fetchAndCreateCard("Beedrill");
  await fetchAndCreateCard("Paras");
  await fetchAndCreateCard("Parasect");
  await fetchAndCreateCard("Scyther"); 
  await fetchAndCreateCard("Venomoth"); 
  await fetchAndCreateCard("Pinsir");
  await fetchAndCreateCard("Weedle");
  await fetchAndCreateCard("Caterpie");
  await fetchAndCreateCard("Metapod");
  await fetchAndCreateCard("Venonat");  
})();