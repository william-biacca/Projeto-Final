...
(async function init() {
  await fetchAndCreateCard("Clefairy")
  await fetchAndCreateCard("Clefable");
   await fetchAndCreateCard("Cleffa");
  await fetchAndCreateCard("Jigglypuff"); 
  await fetchAndCreateCard("Wigglytuff");
  await fetchAndCreateCard("Igglybuff");
  await fetchAndCreateCard("Togepi");
  await fetchAndCreateCard("Togetic");
    await fetchAndCreateCard("Snubbull"); 
   await fetchAndCreateCard("Marill");
     await fetchAndCreateCard("mr-mime");
  await fetchAndCreateCard("Azumarill"); 
