...
(async function init() {
  await fetchAndCreateCard("Sandshrew");
  await fetchAndCreateCard("Sandslash");
  await fetchAndCreateCard("Diglett");
  await fetchAndCreateCard("Dugtrio");
  await fetchAndCreateCard("Geodude");
  await fetchAndCreateCard("Graveler");
  await fetchAndCreateCard("Golem");
  await fetchAndCreateCard("Onix");
  await fetchAndCreateCard("Cubone");
  await fetchAndCreateCard("Marowak");
  await fetchAndCreateCard("Nidoqueen");
